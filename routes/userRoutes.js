...
// Merge request routes (for mutual connections)
userRouter.post('/merge-request', userAuth, sendMergeRequest);
userRouter.get('/merge-requests', userAuth, getMergeRequests);
