...
const connectDB = async (retries = 5, delay = 3000) => {
  try {
    if (!dbURI) {
      ...
      console.error(
        "💡 Please create a .env file with: MONGODB_URI=mongodb://localhost:27017/your-database-name",
      );
      console.error(
        "💡 Or use MongoDB Atlas: MONGODB_URI=mongodb+srv://username:password@cluster.mongodb.net/database",
      );
      process.exit(1);
    }
